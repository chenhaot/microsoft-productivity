...
\para{Expected results.} We expect to build a collaborative writing webapp that can serve as a common experimentation platform for future research in machine-in-the-loop collaborative writing.
